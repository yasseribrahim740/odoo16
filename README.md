...
``` bash
curl -s https://raw.githubusercontent.com/yasseribrahim740/odoo16/main/run.sh | sudo bash -s odoo-one 10016 20016
```
and/or run the following to set up another Odoo instance @ `localhost:11016` :

``` bash
curl -s https://raw.githubusercontent.com/yasseribrahim740/odoo16/main/run.sh | sudo bash -s odoo-two 11016 21016
```
...
* The default password (**admin_passwd**) is 'abutaleb', you can always change it @ [etc/odoo.conf#L60](/etc/odoo.conf#L60)
